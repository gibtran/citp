  ...
  return (
    <PageShell eyebrow="8 · Prototyping" title="Prototype & Testing">
      ...
      <p>
        ...
        expansion. These parts were selected since it supports the practical ranger needs in remote
        conditions while remain the sustainable
      </p>
      ...
      <p>
        ...
        explore the size, spacing, access points, and arrangement of the 2.5 m × 2.5 m modules
      ...
      <p>
        ...
        and future expansion. However, the digital prototype does not test physical strength,
        performance, or weather resistance.
      </p>
      ...
      <p>
        Since the prototype was developed digitally, our team tries to focus on the evaluation by
        reviewing the design concept against the project’s design criteria rather than physical
        testing. The team reviewed whether the layout was clear, whether users could move logically
        between spaces, whether storage areas appeared accessible, and whether additional modules
      ...
      <h2>Summary</h2>
      <p>
        The digital prototype indicated that the Modular Service Hub is a possible design for
        development. It showed how a 2.5 m × 2.5 m module could work as a basic building unit and
        how the hub could be expanded over time through additional modules. However, further
        community feedback, technical review, and real-world testing would be required before
        implementation.
      </p>
    </PageShell>
  );
